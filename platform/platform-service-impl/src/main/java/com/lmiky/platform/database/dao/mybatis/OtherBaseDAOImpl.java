...
public class OtherBaseDAOImpl extends AbstractBaseDAOImpl implements BaseDAO {


	/* (non-Javadoc)
     * @see com.lmiky.platform.database.dao.mybatis.AbstractBaseDAOImpl#setSqlSessionTemplate(org.mybatis.spring.SqlSessionTemplate)
     */
    @Override
    @Resource(name = "otherSqlSessionTemplate")
